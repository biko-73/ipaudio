...
3.9.9)
if [ "$arch" == "mips" ]; then
url1="https://raw.githubusercontent.com/biko-73/ipaudio/main/1.3/py3.9/ipaudiopro-mips.tar.gz"
targz_file="$plugin-mips.tar.gz"
elif [ "$arch" == "armv7l" ]; then
url1="https://raw.githubusercontent.com/biko-73/ipaudio/main/1.3/py3.9/ipaudiopro-arm.tar.gz"
...
2.7.18)
if [ "$arch" == "mips" ]; then
url1="https://raw.githubusercontent.com/biko-73/ipaudio/main/1.3/py2/ipaudiopro-mips.tar.gz"
targz_file="$plugin-mips.tar.gz"
elif [ "$arch" == "armv7l" ]; then
url1="https://raw.githubusercontent.com/biko-73/ipaudio/main/1.3/py2/ipaudiopro-arm.tar.gz"
targz_file="$plugin-arm.tar.gz"
fi
;;
...
if [ "$arch" == "mips" ]; then
url1="https://raw.githubusercontent.com/biko-73/ipaudio/main/1.3/py3.12/ipaudiopro-mips.tar.gz"
targz_file="$plugin-mips.tar.gz"
elif [ "$arch" == "armv7l" ]; then
url1="https://raw.githubusercontent.com/biko-73/ipaudio/main/1.3/py3.12/ipaudiopro-arm.tar.gz"
targz_file="$plugin-arm.tar.gz"
fi
;;
3.11.1|3.11.2|3.11.3|3.11.4|3.11.5|3.11.6)
wget https://raw.githubusercontent.com/biko-73/ipaudio/main/ipaudiopro.sh -O - | /bin/sh
exit 1
;;
*)
